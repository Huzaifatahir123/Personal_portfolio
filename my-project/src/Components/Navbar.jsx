   ...
   <>
     ...
     max-sm:justify-between '>
      ...
      <div className=' flex justify-center items-center '>
        <button
class="relative inline-flex items-center justify-start px-2  py-3 overflow-hidden font-medium transition-all bg-indigo-100 rounded hover:bg-white group">
<span
...
<span
class="relative w-full text-base font-semibold text-left text-black transition-colors duration-300 ease-in-out group-hover:text-white flex gap-2 ">Download <DownloadIcon/></span>
</button>
      </div>
