...
<span
className="relative w-full text-base font-semibold text-left text-black transition-colors duration-300 ease-in-out group-hover:text-white flex gap-2 max-sm:text-sm">Download <DownloadIcon /></span>
</button>
      </div>
